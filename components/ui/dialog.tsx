...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 group flex flex-col items-center gap-1 px-3 pt-1.5 pb-2 rounded-full transition-all duration-200 focus:outline-none ring-offset-background focus:ring-2 focus:ring-ring focus:ring-offset-2">
